public class persona{
  ...
  public void setEnergia(int energia) {
    ...
    void alterarEnergia(int alteracao) {
      ...
      if (alteracao > 0) {
        System.out.println("Este movimento,  Alterou no Personagem " + this.nomepers + " restaurando " + alteracao
            + " Pontos de Energia. ");
      } else {
        System.out.println("Este movimento,  Alterou no Personagem " + this.nomepers + " consumindo " + alteracao
            + " Pontos de Energia. ");
      }
